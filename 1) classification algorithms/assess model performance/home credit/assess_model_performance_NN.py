...
path1 = '1) classification algorithms/neural networks/home credit/model_NN_unbalanced_home.pkl'
# with open(path, 'rb') as file:
#     unbalanced_model = pickle.load(file)
unbalanced_model = load_model(path1)

# unpack balanced model
path2 = '1) classification algorithms/neural networks/home credit/model_NN_balanced_home.pkl'
# with open(path, 'rb') as file:
...
plt.savefig('1) classification algorithms/assess model performance/home credit/figures/PRcurve_nn_unbalanced_churn.png')
plt.close()
get_model_performance(balanced_model, 'balanced', X_test_balanced, y_test_balanced, 'NN','satisfaction dataset')
plt.savefig('1) classification algorithms/assess model performance/home credit/figures/PRcurve_nn_balanced_churn.png')
plt.close()
print('PR curve ready')

cm_analysis(y_test_balanced,balanced_predictions,filename='1) classification algorithms/assess model performance/home credit/figures/cm_nn_balanced_sat.png',labels=[0, 1],
            ymap=['normal','not happy'],title='NN performance on balanced data\nsatisfaction dataset')

cm_analysis(y_test_unbalanced,unbalanced_predictions,filename='1) classification algorithms/assess model performance/home credit/figures/cm_nn_unbalanced_sat.png',labels=[0, 1],
