...
cm_analysis(y_test_balanced,balanced_predictions,filename='4) final figures/cm_NN_balanced',labels=[0, 1],
            ymap=['normal','fraud'],title='NN performance on balanced data')

cm_analysis(y_test_unbalanced,unbalanced_predictions,filename='4) final figures/cm_NN_unbalanced',labels=[0, 1],
