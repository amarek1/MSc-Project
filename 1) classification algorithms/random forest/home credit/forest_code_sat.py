# balanced {'bootstrap': True, 'max_depth': 5, 'min_samples_split': 10, 'n_estimators': 100}
# unbalanced
...
def get_forest_model(data=data, balanced=False, model_name='model_forest_unbalanced_home.pkl'):
    ...
    path = '1) classification algorithms/random forest/home credit/' + model_name
