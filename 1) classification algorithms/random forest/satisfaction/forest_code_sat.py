...
def get_forest_model(data=data, balanced=False, model_name='model_forest_unbalanced_sat.pkl'):
    ...
    path = '1) classification algorithms/random forest/satisfaction/' + model_name
