...
def get_forest_model(data=data, balanced=True, model_name='model_forest_balanced_bio_vm_test.pkl'):
    ...
    summary_df.to_csv(
        '1) classification algorithms/random forest/bioresponse/balanced_forest.csv',
        index=False)
