...
cm_analysis(y_test_balanced,balanced_predictions,filename='4) final figures/cm_rf_balanced_ori',labels=[0, 1],
            ymap=['normal','fraud'],title='RF performance on balanced data')

cm_analysis(y_test_unbalanced,unbalanced_predictions,filename='4) final figures/cm_rf_unbalanced_ori',labels=[0, 1],
