...
def get_SVM_model(data=data, kernel='rbf', gamma=0.0001, C=1000, probability=True, model_name='model_SVM_balanced_churn.pkl'):
    ...
    path = '1) classification algorithms/SVM/customer churn/'+model_name
