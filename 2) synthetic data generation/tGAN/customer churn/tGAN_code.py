...
tgan = TGANModel(continuous_columns, output='2) synthetic data generation/tGAN/customer churn/6000 iterations/', max_epoch=1, steps_per_epoch=6000, save_checkpoints=True,
...
tgan.fit(fraud_data)
model_path = '2) synthetic data generation/tGAN/customer churn/6000 iterations/tGAN_churn_model.pkl'
...
samples.to_pickle('2) synthetic data generation/tGAN/customer churn/6000 iterations/tGAN_churn_5000.pkl')
