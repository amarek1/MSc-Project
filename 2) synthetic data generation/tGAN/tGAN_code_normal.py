...
continuous_columns = [*range(0, len(ori_data.columns)-1)]

tgan = TGANModel(continuous_columns, output='2) synthetic data generation/tGAN/customer churn/normal/', max_epoch=1, steps_per_epoch=6000, save_checkpoints=True,
...
tgan.fit(fraud_data)
model_path = '2) synthetic data generation/tGAN/customer churn/normal/tGAN_normal_model.pkl'
...
samples.to_pickle('2) synthetic data generation/tGAN/customer churn/normal/tGAN_normal_5174.pkl')
