...
tgan = TGANModel(continuous_columns, output='output2', max_epoch=1, steps_per_epoch=6000, save_checkpoints=True,
...
# tgan.fit(fraud_data)
# model_path = 'output2/tGAN_normal_284315.pkl'
...
samples.to_pickle('2) synthetic data generation/tGAN/credit card fraud/tGAN_normal_284315.pkl')
