...
tgan = TGANModel(continuous_columns, output='2) synthetic data generation/tGAN/customer churn/normal/', max_epoch=1, steps_per_epoch=2000, save_checkpoints=True,
