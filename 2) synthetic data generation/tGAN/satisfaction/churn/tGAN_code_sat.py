...
tgan = TGANModel(continuous_columns, output='2) synthetic data generation/tGAN/satisfaction/churn/', max_epoch=1,
...
tgan.fit(fraud_data)
model_path = '2) synthetic data generation/tGAN/satisfaction/satisfaction/tGAN_sat_model.pkl'
...
samples.to_pickle('2) synthetic data generation/tGAN/satisfaction/churn/tGAN_sat_5000.pkl')
