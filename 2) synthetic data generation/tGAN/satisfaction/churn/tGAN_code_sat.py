...
tgan = TGANModel(continuous_columns, output='2) synthetic data generation/tGAN/satisfaction/6000 iterations/', max_epoch=1,
...
tgan.fit(fraud_data)
model_path = '2) synthetic data generation/tGAN/satisfaction/6000 iterations/tGAN_sat_model.pkl'
...
samples.to_pickle('2) synthetic data generation/tGAN/satisfaction/6000 iterations/tGAN_sat_5000.pkl')
