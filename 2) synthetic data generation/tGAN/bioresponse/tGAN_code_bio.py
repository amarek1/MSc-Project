...
# '--gpu'
tgan = TGANModel(continuous_columns=continuous, output='2) synthetic data generation/tGAN/bioresponse/1/', gpu='0', max_epoch=2, steps_per_epoch=1500, save_checkpoints=False,
