...
# '--gpu'
tgan = TGANModel(continuous_columns=continuous, output='2) synthetic data generation/tGAN/bioresponse/1/', gpu=1, max_epoch=['0','1'], steps_per_epoch=6000, save_checkpoints=False,
