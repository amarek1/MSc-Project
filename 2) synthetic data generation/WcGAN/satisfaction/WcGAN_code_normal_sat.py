...
cluster_spec = importlib.util.spec_from_file_location("k means classes_normal.py",
                                                      ...
                                                      "2) synthetic data generation/cGAN/satisfaction/"
...
def WcGAN_generate_data(data=data, rand_dim=43, base_n_count=128, nb_steps=6000 + 1, batch_size=256, k_d=5, k_g=1,
    ...
    plt.savefig('2) synthetic data generation/WcGAN/satisfaction/WcGAN results/'+gen_data_name+'.png',
                bbox_inches='tight')
    # plt.show()

    with open('2) synthetic data generation/WcGAN/satisfaction/WcGAN results/'+gen_data_name+'.txt','w')as a:
