...
def WcGAN_generate_data(data=data, rand_dim=41, base_n_count=128, nb_steps=6000 + 1, batch_size=256, k_d=5, k_g=1,
                      critic_pre_train_steps=100, log_interval=100, learning_rate=1e-3,
                      data_dir='2) synthetic data generation/WcGAN/customer churn/WcGAN training/churn_',
                      gen_data_size=5000, gen_data_name='WcGAN_churn_5000_2'):
