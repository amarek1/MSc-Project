...
def GAN_generate_data(data=data, rand_dim=32, base_n_count=128, nb_steps=6000 + 1, batch_size=128, k_d=1, k_g=1,
    ...
    plt.savefig('2) synthetic data generation/GAN/satisfaction/'+gen_data_name+'.png')
    plt.show()

    with open('2) synthetic data generation/GAN/satisfaction/'+gen_data_name+'.txt','w')as a:
