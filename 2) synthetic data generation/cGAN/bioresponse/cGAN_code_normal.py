...
def cGAN_generate_data(data=data, rand_dim=34, base_n_count=128, nb_steps=6000 + 1, batch_size=128, k_d=1, k_g=1,
                      ...
                      data_dir='2) synthetic data generation/cGAN/bioresponse/cGAN training/bio_0_',
                      gen_data_size=3000, gen_data_name='cGAN_bio_0_3000'):
    ...
    plt.legend()
    plt.title('cGAN training - bioresponse dataset')
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
