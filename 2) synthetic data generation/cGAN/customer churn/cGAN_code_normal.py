...
def cGAN_generate_data(data=data, rand_dim=35, base_n_count=128, nb_steps=6000 + 1, batch_size=128, k_d=1, k_g=1,
                      critic_pre_train_steps=100, log_interval=100, learning_rate=1e-3,
                      data_dir='2) synthetic data generation/cGAN/customer churn/cGAN training/normal_',
                      gen_data_size=len(data), gen_data_name='cGAN_normal_5174'):
    ...
    arguments = [rand_dim, nb_steps, batch_size,
                 k_d, k_g, critic_pre_train_steps, log_interval, learning_rate, base_n_count, data_dir,
    ...
    generator_model.load_weights(data_dir+'CGAN_generator_model_weights_step_'+str(best_step_x)+'.h5')
    ...
    df.to_pickle('2) synthetic data generation/CGAN/customer churn/'+gen_data_name+'.pkl')
    ...
    plt.savefig('2) synthetic data generation/CGAN/customer churn/'+gen_data_name+'.png')
    plt.show()

    with open('2) synthetic data generation/CGAN/customer churn/'+gen_data_name+'.txt','w')as a:
