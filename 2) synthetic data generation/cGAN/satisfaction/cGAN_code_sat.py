...
def cGAN_generate_data(data=data, rand_dim=48, base_n_count=128, nb_steps=6000 + 1, batch_size=256, k_d=1, k_g=1,
                      ...
                      gen_data_size=1, gen_data_name='cGAN_sat_5000'):
    ...
    df.to_pickle('2) synthetic data generation/CGAN/satisfaction/'+gen_data_name+'.pkl')
    ...
    plt.savefig('2) synthetic data generation/CGAN/satisfaction/'+gen_data_name+'.png')
    plt.show()

    with open('2) synthetic data generation/CGAN/satisfaction/'+gen_data_name+'.txt','w')as a:
