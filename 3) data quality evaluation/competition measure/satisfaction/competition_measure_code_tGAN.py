...
file_name = '2) synthetic data generation/tGAN/satisfaction/normal/tGAN_normal_sat_73012.pkl'
syn_data_normal = pd.read_pickle(file_name)
syn_data_normal = syn_data_normal.astype('float64')
...
syn_data = pd.concat([syn_data_fraud, syn_data_normal], sort=False)
syn_data = syn_data.astype('float64')
...
print('real accuracy done')
syn_accuracy = get_accuracies(syn_data)
print('syn accuracy done')
