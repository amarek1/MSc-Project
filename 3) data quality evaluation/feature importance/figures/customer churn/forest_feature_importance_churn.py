...
def unpack_model(model_name):
    path = '3) data quality evaluation/feature importance/models/customer churn/' + model_name
...
plt.grid()
plt.tight_layout()
plt.savefig('3) data quality evaluation/feature importance/figures/customer churn/FI_plot.png')
...
plt.title('Distance between real and synthetic featureimportance scores\nfor churn dataset')
...
plt.savefig('3) data quality evaluation/feature importance/figures/customer churn/FI_score_normalised.png')