...
def unpack_model(model_name):
    path = '3) data quality evaluation/feature importance/models/satisfaction/' + model_name
    with open(path, 'rb') as file:
        model = pickle.load(file)
        return model

real_model = unpack_model('FI_real_73012_3008_0_ts0.25.pkl')
synthpop_model = unpack_model('FI_synthpop_73012_0_3008_ts0.25.pkl')
GAN_model = unpack_model('FI_GAN_73012_0_3008_ts0.25.pkl')
cGAN_model = unpack_model('FI_cGAN_73012_0_3008_ts0.25.pkl')
WGAN_model = unpack_model('FI_WGAN_73012_0_3008_ts0.25.pkl')
WcGAN_model = unpack_model('FI_WcGAN_73012_0_3008_ts0.25.pkl')
tGAN_model = unpack_model('FI_tGAN_73012_0_3008_ts0.25.pkl')
...
plt.title('Random forest feature importance scores\nfor satisfaction dataset')
plt.grid()
plt.tight_layout()
plt.savefig('3) data quality evaluation/feature importance/figures/satisfaction/FI_scatterplot.png')
...
plt.savefig('3) data quality evaluation/feature importance/figures/satisfaction/FI_score_normalised.png')
