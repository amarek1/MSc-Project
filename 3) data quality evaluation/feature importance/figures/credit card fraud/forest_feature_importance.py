...
def unpack_model(model_name):
    path = '3) data quality evaluation/feature importance/models/credit card fraud/' + model_name
...
plt.savefig('3) data quality evaluation/feature importance/figures/credit card fraud/FI_score_normalised.png')
