...
def get_forest_model(real_data=real_data, synthetic_data=synthetic_fraud, folder='bioresponse', model_name='FI',
...
nr_normal_training = [2034]
nr_fraud_training = [0]
nr_synthetic_fraud_training = [350]
for i in range(0, len(nr_normal_training)):
    get_forest_model(real_data=real_data, synthetic_data=synthetic_fraud, folder='models/bioresponse', model_name='FI',
