...
def unpack_model(model_name):
    path = '4) final figures/performance improvement/models/feature importance/customer churn/' + model_name
    with open(path, 'rb') as file:
        model = pickle.load(file)
        return model

real_model = unpack_model('FI_real_churn_3847_1435_0_ts0.25.pkl')
synthpop_model = unpack_model('FI_synthpop_churn_3847_0_1435_ts0.25.pkl')
GAN_model = unpack_model('FI_GAN_churn_3847_0_1435_ts0.25.pkl')
cGAN_model = unpack_model('FI_cGAN_churn_3847_0_1435_ts0.25.pkl')
WGAN_model = unpack_model('FI_WGAN_churn_3847_0_1435_ts0.25.pkl')
WcGAN_model = unpack_model('FI_WcGAN_churn_3847_0_1435_ts0.25.pkl')
tGAN_model = unpack_model('FI_tGAN_churn_3847_0_1435_ts0.25.pkl')
...
plt.title('Random forest feature importance for churn dataset')
plt.grid()
plt.tight_layout()
plt.savefig('3) data quality evaluation/feature importance/customer churn/FI_plot.png')


# calculate overall score
FI_real = FI_real+0.001 # so that we don't divide by 0
print(abs(FI_real.values-FI_synthpop.values)/FI_real.values)
...
plt.title('Distance between real and synthetic feature importance scores for churn dataset')
...
plt.savefig('3) data quality evaluation/feature importance/customer churn/FI_score_normalised.png')
