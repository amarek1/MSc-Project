...
for i in range(0, len(nr_normal_training)):
    get_forest_model(real_data=real_data, synthetic_data=synthpop_fraud, folder='real and synthetic/models', model_name='real&syn',
...
nr_synthetic_fraud_training = [0,400,800,1200,1600,2000]
for i in range(0, len(nr_normal_training)):
    get_forest_model(real_data=real_data, synthetic_data=GAN_fraud, folder='real and synthetic/models', model_name='real&syn',
...
nr_synthetic_fraud_training = [0,400,800,1200,1600,2000]
for i in range(0, len(nr_normal_training)):
    get_forest_model(real_data=real_data, synthetic_data=cGAN_fraud, folder='real and synthetic/models', model_name='real&syn',
...
nr_synthetic_fraud_training = [0,400,800,1200,1600,2000]
for i in range(0, len(nr_normal_training)):
    get_forest_model(real_data=real_data, synthetic_data=WGAN_fraud, folder='real and synthetic/models', model_name='real&syn',
...
nr_synthetic_fraud_training = [0,400,800,1200,1600,2000]
for i in range(0, len(nr_normal_training)):
    get_forest_model(real_data=real_data, synthetic_data=WcGAN_fraud, folder='real and synthetic/models', model_name='real&syn',
...
# nr_synthetic_fraud_training = [0,400,800,1200,1600,2000]
# for i in range(0, len(nr_normal_training)):
#     get_forest_model(real_data=real_data, synthetic_data=tGAN_fraud, folder='real and synthetic/models', model_name='real&syn',
