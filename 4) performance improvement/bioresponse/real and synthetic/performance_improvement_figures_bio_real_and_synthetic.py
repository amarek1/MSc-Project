...
def get_performance_report(dataset='bioresponse', model_nr='rf', model_type='synthpop', nr_normal_training=[213224],
...
#     plt.xlabel('# synthetic class1')
#     plt.title('The effect of adding synthetic bioresponse data\ngenerated by '+ model +' on '+parameter)
#     plt.grid()
#     plt.legend()
#     plt.savefig('4) performance improvement/bioresponse/real and synthetic/figures/plots/'+parameter+'_'+keys[len(keys)-1]+'.png')
#     plt.close()
...
def plot_performance3(x_axis_steps=[0, 100, 200, 300, 381], report_dict=dict(), fraud_par='fraud', normal_par='normal',
    ...
    a[fig_nr[0],fig_nr[1]].set_xlabel("# synthetic class1", fontsize=9)
    ...
    plt.suptitle('The effect of adding synthetic bioresponse data generated\nby various methods on recall/precision')
    ...
    if save == True:
        f.savefig('4) performance improvement/bioresponse/real and synthetic/figures/plots/one_figure_for_all_precision&recall.png')
...
plot_performance3(x_axis_steps=[0, 400, 800, 1200, 1600, 2000], report_dict=GAN_report, fraud_par='class1', normal_par='class0',
...
plot_performance3(x_axis_steps=[0, 400, 800, 1200, 1600, 2000], report_dict=cGAN_report, fraud_par='class1', normal_par='class0',
...
plot_performance3(x_axis_steps=[0, 400, 800, 1200, 1600, 2000], report_dict=WcGAN_report, fraud_par='class1', normal_par='class0',
                      parameter='precision', model='WcGAN', fig_nr=[2,1], save=True)
