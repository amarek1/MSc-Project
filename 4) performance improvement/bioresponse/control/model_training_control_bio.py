...
synthetic_fraud = pd.concat([train_data.loc[train_data['class']==1]]*6, ignore_index=True)
...
nr_normal_training = [2034, 2034, 2034, 2034, 2034, 2034]  # number of real normal datapoints
nr_fraud_training = [350,350,350,350,350,350]  # number of real fraud datapoints
nr_synthetic_fraud_training = [0,400,800,1200,1600,2000]  # number of real fraud datapoints duplicated
for i in range(0, len(nr_normal_training)):
    get_forest_model(real_data=real_data, synthetic_data=synthetic_fraud, folder='control/models', model_name='rf',
                     model_type='control_bio', nr_normal_training=nr_normal_training[i], nr_fraud_training=nr_fraud_training[i],
