...
def get_forest_model(real_data=real_data, synthetic_data=synthetic_fraud, folder='control/models', model_name='rf',
                     model_type='control_churn', nr_normal_training=3847, nr_fraud_training=1435, nr_synthetic_fraud_training=0,
                     test_size=0.25):
...
nr_normal_training = [3847, 3847, 3847, 3847, 3847, 3847]  # number of real normal datapoints
nr_fraud_training = [1435, 1435, 1435, 1435, 1435, 1435]  # number of real fraud datapoints
nr_synthetic_fraud_training = [0, 500, 1000, 1500, 2000, 2500]  # number of real fraud datapoints duplicated
for i in range(0, len(nr_normal_training)):
    get_forest_model(real_data=real_data, synthetic_data=synthetic_fraud, folder='control/models', model_name='rf',
                     model_type='control_churn', nr_normal_training=nr_normal_training[i], nr_fraud_training=nr_fraud_training[i],
