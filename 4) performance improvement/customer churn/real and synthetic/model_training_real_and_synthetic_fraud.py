...
file_name = 'data/customer churn/synthpop_churn_5000.pkl'
synthpop_fraud = pd.read_pickle(file_name)

file_name = '2) synthetic data generation/GAN/customer churn/GAN_churn_5000_2.pkl'
GAN_fraud = pd.read_pickle(file_name)

file_name = '2) synthetic data generation/cGAN/customer churn/cGAN_churn_5000_2.pkl'
cGAN_fraud = pd.read_pickle(file_name)

file_name = '2) synthetic data generation/WGAN/customer churn/WGAN_churn_5000_2.pkl'
...
def get_forest_model(real_data=real_data, synthetic_data=GAN_fraud, folder='real and synthetic/models', model_name='m1',
    ...
    path = '4) performance improvement/customer churn/' + folder + '/' + model_name
...
for i in range(0, len(nr_normal_training)):
    get_forest_model(real_data=real_data, synthetic_data=synthpop_fraud, folder='real and synthetic/models', model_name='rf',
...
nr_synthetic_fraud_training = [0, 500, 1000, 1500, 2000, 2500]
for i in range(0, len(nr_normal_training)):
    get_forest_model(real_data=real_data, synthetic_data=GAN_fraud, folder='real and synthetic/models', model_name='rf',
...
nr_synthetic_fraud_training = [0, 500, 1000, 1500, 2000, 2500]
for i in range(0, len(nr_normal_training)):
    get_forest_model(real_data=real_data, synthetic_data=cGAN_fraud, folder='real and synthetic/models', model_name='rf',
...
nr_synthetic_fraud_training = [0, 500, 1000, 1500, 2000, 2500]
for i in range(0, len(nr_normal_training)):
    get_forest_model(real_data=real_data, synthetic_data=WGAN_fraud, folder='real and synthetic/models', model_name='rf',
...
nr_synthetic_fraud_training = [0, 500, 1000, 1500, 2000, 2500]
for i in range(0, len(nr_normal_training)):
    get_forest_model(real_data=real_data, synthetic_data=WcGAN_fraud, folder='real and synthetic/models', model_name='rf',
...
nr_synthetic_fraud_training = [0, 500, 1000, 1500, 2000, 2500]
for i in range(0, len(nr_normal_training)):
    get_forest_model(real_data=real_data, synthetic_data=tGAN_fraud, folder='real and synthetic/models', model_name='rf',
