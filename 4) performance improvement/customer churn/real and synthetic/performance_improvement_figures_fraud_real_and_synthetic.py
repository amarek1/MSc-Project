...
#                      ha='center')
#
#     plt.plot(x_axis_steps, y_values, marker='o', label=parameter+' for churn')
#
#
#     y_values = list()
#     keys = list(report_dict.keys())
...
#     plt.title('The effect of adding synthetic churn data\ngenerated by '+ model +' on '+parameter)
#     plt.grid()
#     plt.legend()
...
def plot_performance3(x_axis_steps=[0, 100, 200, 300, 381], report_dict=dict(), fraud_par='fraud', normal_par='normal',
    ...
    a[fig_nr[0],fig_nr[1]].set_xlabel("# churn", fontsize=9)
    ...
    plt.suptitle('The effect of adding synthetic churn data generated\nby various methods on recall/precision')
    ...
    if save == True:
        f.savefig('4) performance improvement/customer churn/real and synthetic/figures/plots/one_figure_for_all_precision&recall.png')
