...
def get_performance_report(dataset='customer churn', model_nr='rf', model_type='synthpop', nr_normal_training=[213224],
...
def plot_performance3(x_axis_steps=[0, 100, 200, 300, 381], report_dict=dict(), fraud_par='fraud', normal_par='normal',
    ...
    plt.grid()
    plt.legend()
    plt.savefig('4) performance improvement/customer churn/real and synthetic/figures/plots/'+parameter+'_'+keys[len(keys)-1]+'.png')
    plt.close()

###################################### run the functions ###################################

synthpop_report = get_performance_report(model_nr='rf', model_type='synthpop',
...
GAN_report = get_performance_report(model_nr='rf', model_type='GAN',
                                    nr_normal_training=[3847, 3847, 3847, 3847, 3847, 3847],
                                    nr_fraud_training=[1435, 1435, 1435, 1435, 1435, 1435],
                                    nr_synthetic_fraud_training=[0, 500, 1000, 1500, 2000, 2500])
...
cGAN_report = get_performance_report(model_nr='rf', model_type='cGAN',
                                     nr_normal_training=[3847, 3847, 3847, 3847, 3847, 3847],
                                     nr_fraud_training=[1435, 1435, 1435, 1435, 1435, 1435],
                                     nr_synthetic_fraud_training=[0, 500, 1000, 1500, 2000, 2500])
...
WGAN_report = get_performance_report(model_nr='rf', model_type='WGAN',
                                     nr_normal_training=[3847, 3847, 3847, 3847, 3847, 3847],
                                     nr_fraud_training=[1435, 1435, 1435, 1435, 1435, 1435],
                                     nr_synthetic_fraud_training=[0, 500, 1000, 1500, 2000, 2500])
...
WcGAN_report = get_performance_report(model_nr='rf', model_type='WcGAN',
                                      nr_normal_training=[3847, 3847, 3847, 3847, 3847, 3847],
                                      nr_fraud_training=[1435, 1435, 1435, 1435, 1435, 1435],
                                      nr_synthetic_fraud_training=[0, 500, 1000, 1500, 2000, 2500])
...
tGAN_report = get_performance_report(model_nr='rf', model_type='tGAN',
                                     nr_normal_training=[3847, 3847, 3847, 3847, 3847, 3847],
                                     nr_fraud_training=[1435, 1435, 1435, 1435, 1435, 1435],
                                     nr_synthetic_fraud_training=[0, 500, 1000, 1500, 2000, 2500])
