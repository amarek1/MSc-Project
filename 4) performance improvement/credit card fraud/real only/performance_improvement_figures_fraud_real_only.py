...
real_and_syn_report = get_performance_report(dataset='credit card fraud', model_nr='rf', model_type='real_only',
...
def plot_performance3(x_axis_steps=[0, 500, 1000, 2000, 3000, 4000, 5000], report_dict=real_and_syn_report, fraud_par='fraud', normal_par='normal',
    ...
    plt.grid()
    plt.legend()
    plt.savefig('4) performance improvement/credit card fraud/real only/figures/plots/'+parameter+'_'+keys[len(keys)-1]+'.png')
    plt.close()

###################################### run the functions ###################################

control_report = get_performance_report(dataset='credit card fraud', model_nr='rf', model_type='real_only',
                                        nr_normal_training=[213224, 213224, 213224, 213224, 213224],
                                        nr_fraud_training=[0, 100, 200, 300, 381],
                                        nr_synthetic_fraud_training=[0, 0, 0, 0, 0])

plot_performance3(x_axis_steps=[0, 100, 200, 300, 381], report_dict=control_report, fraud_par='fraud', normal_par='normal',
