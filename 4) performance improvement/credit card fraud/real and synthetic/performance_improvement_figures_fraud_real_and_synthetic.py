...
def plot_performance3(x_axis_steps=[0, 100, 200, 300, 381], report_dict=dict(), fraud_par='fraud', normal_par='normal',
    ...
    a[fig_nr[0],fig_nr[1]].set_xlabel("# fraud (x1000)", fontsize=9)
    ...
    plt.suptitle('The effect of adding synthetic fraud data generated\nby various methods on recall/precision')
    ...
    if save == True:
        f.savefig('4) performance improvement/credit card fraud/real and synthetic/figures/plots/one_figure_for_all_precision&recall.png')
