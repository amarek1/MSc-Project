...
def plot_performance3(x_axis_steps=[0, 100, 200, 300, 381], report_dict=dict(), fraud_par='fraud', normal_par='normal',
    ...
    a[fig_nr[0],fig_nr[1]].set_xlabel("# fraud", fontsize=9)
    a[fig_nr[0],fig_nr[1]].set_ylabel(parameter, fontsize=9)
    plt.setp(a, yticks=[0.8,0.85,0.9,0.95,1])
    plt.suptitle('The effect of adding synthetic fraud data\ngenerated by various methods on '+parameter)
    ...
    f.legend(handles=[orange_line, blue_line])

    if save == True:
        f.savefig('4) performance improvement/credit card fraud/real and synthetic/figures/plots/one_figure_for_all_'+parameter+'.png')
...
plot_performance3(x_axis_steps=[0, 500, 1000, 2000, 3000, 4000, 5000], report_dict=GAN_report, fraud_par='fraud', normal_par='normal',
                      parameter='recall', model='GAN',fig_nr=[0,1])
...
plot_performance3(x_axis_steps=[0, 500, 1000, 2000, 3000, 4000, 5000], report_dict=WGAN_report, fraud_par='fraud', normal_par='normal',
                      parameter='recall', model='WGAN', fig_nr=[1,1])
...
plot_performance3(x_axis_steps=[0, 500, 1000, 2000, 3000, 4000, 5000], report_dict=tGAN_report, fraud_par='fraud', normal_par='normal',
                      parameter='recall', model='tGAN', fig_nr=[2,1], save=True)
