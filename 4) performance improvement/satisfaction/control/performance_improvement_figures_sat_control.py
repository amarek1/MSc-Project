...
#     plt.xlabel('# duplicated class1 data')
#     plt.title('The effect of adding duplicated satisfaction data on '+parameter)
#     plt.grid()
#     plt.legend()
#     plt.savefig('4) performance improvement/satisfaction/control/figures/plots/'+parameter+'_'+keys[len(keys)-1]+'.png')
#     plt.close()
...
def plot_performance3(x_axis_steps=[0, 100, 200, 300, 381], report_dict=dict(), fraud_par='fraud', normal_par='normal',
    ...
    plt.suptitle('The effect of adding duplicated\nsatisfaction data on recall/precision', fontsize=10)
    ...
    if save == True:
        f.savefig('4) performance improvement/satisfaction/control/figures/plots/one_figure_for_all_precision&recall.png')

###################################### run the functions ###################################


control_report = get_performance_report(dataset='satisfaction', model_nr='rf', model_type='control_sat',
...
plot_performance3(x_axis_steps=[0, 500, 1000, 2000, 3000, 4000, 5000], report_dict=control_report, fraud_par='class1', normal_par='class0',
                  parameter='recall', model='control_sat', fig_nr=[1,0])
...
plot_performance3(x_axis_steps=[0, 500, 1000, 2000, 3000, 4000, 5000], report_dict=control_report, fraud_par='class1', normal_par='class0',
                  parameter='precision', model='control_sat',fig_nr=[1,1], save=True)
